...
extern ULONG pluto_disk_count;
extern ARC_DISK_SIGNATURE_EX pluto_arc_disk_info[];
                       ...
                       USHORT VersionToBoot)
{
    ...
    for (i = 0; i < pluto_disk_count; i++)
    {
        ...
        /* Copy the data over */
        RtlCopyMemory(ArcDiskSig, &pluto_arc_disk_info[i], sizeof(ARC_DISK_SIGNATURE_EX));
