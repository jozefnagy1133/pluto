...
PCSTR FrldrDbgMsg = "Enable FreeLdr debug channels\n"
                    ...
                    "  pluto,linux,hwdetect,windows,peloader,scsiport,heap\n"
                    "Examples:\n"
                    "  trace+windows,trace+pluto\n"
                    "  +hwdetect,err-disk\n"
                    "  +peloader\n"
...
VOID DoOptionsMenu(VOID)
{
    ...
    if (!UiDisplayMenu("Select an option:", "",
                       ...
                       11, // Use "Start pluto normally" as default; see the switch below.
                       -1,
                       &SelectedMenuItem,
                       TRUE,
                       NULL))
